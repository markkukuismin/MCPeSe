...
#' 
#' ARPSSelect = ARPS_v2(HugeSolutionPath)
#' 
#' rhos = ARPSSelect$rhos
#' 
#' Pick the value from the solution path which is closest to the mean value:
#'
#' d = abs(mean(rhos) - HugeSolutionPath$lambda)
#'
...
#'
#' @references Kuismin and Sillanpaa (2020) ARPS: Accept-reject penalty selection forgraphical lasso

ARPS_v2 = function(est, n=NULL, M=5000, g=NULL, method="A-R", prior="unif", MH.sampling="unif",
