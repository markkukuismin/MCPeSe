...
BigARRSe = function(Y, M=NULL, nrho=NULL, rho.min.ratio = NULL, g=NULL, verbose=T){
  ...
  dir.create("BigARRSeSolPath", showWarnings = FALSE)
  
  save(est, file="BigARRSeSolPath/est.RDS")
  ...
  for(i in 2:nrho){
    ...
    saveRDS(est, file=paste("BigARRSeSolPath/est", i, ".RDS", sep=""))
